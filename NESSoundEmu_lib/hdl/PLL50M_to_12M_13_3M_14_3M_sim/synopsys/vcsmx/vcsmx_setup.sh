...
TOP_LEVEL_NAME="PLL50M_to_12M_13_3M_14_3M"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/ext/eda/quartus/21_1_1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL50M_to_12M_13_3M_14_3M.vho"
fi

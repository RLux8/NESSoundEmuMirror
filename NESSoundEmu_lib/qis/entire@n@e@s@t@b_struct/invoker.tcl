...
if {[is_project_open]} {
   if {[string compare $quartus(project) "entireNESTB"]} {
      puts "Project entireNESTB is not open"
      set make_assignments 0
   }
} else {
   # Only open if not already open
   if {[project_exists entireNESTB]} {
      project_open -revision entireNESTB entireNESTB
   } else {
      project_new -revision entireNESTB entireNESTB
   }
...
# Make assignments
if {$make_assignments} {
   set_global_assignment -name COMPILER_SETTINGS entireNESTB
   set_global_assignment -name SIMULATOR_SETTINGS entireNESTB
   set_global_assignment -name SOFTWARE_SETTINGS entireNESTB
   set_global_assignment -name FMAX_REQUIREMENT 50MHz
   set_global_assignment -name FAMILY "cyclone v"
   set_global_assignment -name TOP_LEVEL_ENTITY entireNESTB
   set_global_assignment -name DEVICE 5cgxfc5c6f27c7
   set_global_assignment -name USE_COMPILER_SETTINGS entireNESTB
	set_global_assignment -name VHDL_FILE "/u/home/clab/redacted/eds/NESSoundEmu/NESSoundEmu_lib/hdl/entirenestb_entity.vhd" 
	...
	set_global_assignment -name VHDL_FILE "/u/home/clab/redacted/eds/NESSoundEmu/NESSoundEmu_lib/hdl/sndgrabber_entity.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/clab/redacted/eds/NESSoundEmu/NESSoundEmu_lib/hdl/sndgrabber_behav.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/clab/redacted/eds/NESSoundEmu/NESSoundEmu_lib/hdl/clk_res_gen_var_entity.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/clab/redacted/eds/NESSoundEmu/NESSoundEmu_lib/hdl/clk_res_gen_var_behav.vhd" 
	set_global_assignment -name VHDL_FILE "/u/home/clab/redacted/eds/NESSoundEmu/NESSoundEmu_lib/hdl/entirenestb_struct.vhd" 
